      ...
      <div className="w-full lg:p-0 p-3 rounded-md">
        ...
        <div className="mt-12">
          ...
          <div className="mt-10">
            ...
            <div>
              <h1 className="sm:text-2xl text-xl text-[#045084] font-extrabold mb-5 mt-10">
                2. Blender 3D asset Creation for the Metaverse (Remote Zoom
                Class)
              </h1>
              <div className="lg:text-base text-sm font-normal text-zinc-800 bg-gray-50 md:p-5 p-3 rounded-md">
                <div className="mt-4 mb-4">
                  <div className="">
                    <p>
                      ...
                      real-time 3D (RT3D) space such as Apple, Unity, AMD,
                      Intel, Meta, NVIDIA, AWS, Epic Games, Adobe, Microsoft,
                      and Decentraland. It is expected to become the standard
                      asset creation tool for metaverse.
                    </p>
                  </div>
                </div>
                <div className="mt-4 mb-4">
                  <div className="">
                    <p>Blender 3.3+ Download</p>
                  </div>
                  <div className="">
                    <a
                ...
                <div className="mt-4 mb-4">
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">Blender 3.0 Hotkey</span>
                    </a>
                  </div>
                </div>
                <div className="mt-4 mb-4">
                ...
                <div className="mt-4 mb-4">
                  <div className="">
                    <p>
                      ...
                      Computer Modeling &amp; Animation 7th Edition by John M.
                      Blain
                    </p>
                  </div>
                  <div className="">
                ...
                <div className="mt-4 mb-4">
                  <div className="">
                    <p>Best Hardware Performance for Blender Rendering</p>
                  </div>
                  <div className="">
                    <a
                ...
                <div className="mt-4 mb-4">
                  ...
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">3D donut using blender</span>
                    </a>
                  </div>
                </div>
                <div className="mt-4 mb-4">
                ...
                <div className="mt-4 mb-4">
                  ...
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">
                        3D Sword in the Stone using Blender 3
                      </span>
                    </a>
                  </div>
                </div>
