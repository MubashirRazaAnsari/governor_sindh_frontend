...
const page = () => {
  return (
    ...
    <div className="md:w-[80%] w-full md:mt-[100px] mt-10">
          ...
          <div className="mt-10">
                ...
                <div className="mt-4 mb-4">
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">Web 3.0 User Guide</span>
                    </a>
                  </div>
                </div>
                <div className="mt-4 mb-4">
                ...
                <div className="mt-4 mb-4">
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">JavaScript Book Code</span>
                    </a>
                  </div>
                </div>
                <div className="mt-4 mb-4">
                  ...
                  <div className="">
                    <ul className="list-disc ml-10">
                      <li className="mb-2 mt-2">
                        <div>
                          <p>
                            Background of JavaScript and How to use JavaScript
                            in Browser
                          </p>
                        </div>
                      </li>
                      ...
                      <li className="mb-2 mt-2">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <span className="lowercase">Node.js Intro</span>
                          </a>
                        </div>
                      </li>
                      <li className="mb-2 mt-2">
                        <div>
                          <p>
                            ...
                            The last example in this presentation shows you how
                      ...
                      <li className="mb-2 mt-2">
                        <div>
                          <p>
                            Using Arrays and Objects in Node.js Programs
                      ...
                      <li className="mb-2 mt-2">
                        <div>
                          <p>
                            Using while loop, do while loop, for loop, for in,
                            and for of loop in Node.js (chapter 5 of JavaScript
                      ...
                      <li className="mb-2 mt-2">
                        <div>
                          <p>
                            Using Concurrency, Callbacks, Promises, async /
                            await, and Event loop (chapter 13 of JavaScript from
                            Beginner to Professional)
                          </p>
                        </div>
                      </li>
            ...
            <div>
              ...
              <div className="lg:text-base text-sm font-normal text-zinc-800 bg-gray-50 md:p-5 p-3 rounded-md">
                ...
                <div className="mt-4 mb-4">
                  <div className="">
                    <p>Learning TypeScript in Baby Steps</p>
                  </div>
                  <div className="">
                    <a
                    ...
                    >
                      ...
                      <span className="lowercase">Learning Repository</span>
                    </a>
                  </div>
                </div>
                <div className="mt-4 mb-4">
            ...
            <div>
              ...
              <div className="lg:text-base text-sm font-normal text-zinc-800 bg-gray-50 md:p-5 p-3 rounded-md">
                      ...
                      <li className="mb-2 mt-2">
                        <div>
                          ...
                          >
                            ...
                            <span className="lowercase">Todo App</span>
                          </a>
                        </div>
                      </li>
                      <li className="mb-2 mt-2">
                        <div>
                          ...
                          >
                            ...
                            <span className="lowercase">Pricing Ui</span>
                          </a>
                        </div>
                      </li>
                      <li className="mb-2 mt-2">
                        <div>
                          <p>
                            Build a Panaverse DAO Syllabus Website using Next.js
                            13 given the content from the following document:
                          </p>
                        </div>
                        <div>
                          <a
                      ...
                      <li className="mb-2 mt-2">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <span className="lowercase">PIAIC Syllabus</span>
                          </a>
                        </div>
                        <div></div>
                      </li>
                ...
                <div className="mt-4 mb-4">
                  ...
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">Video Link</span>
                    </a>
                  </div>
                </div>
                <div className="mt-4 mb-4">
                ...
                <div className="mt-4 mb-4">
                  ...
                  <div className="">
                    <a
                      href="https://stackoverflow.com/questions/3329943/what-are-the-differences-between-git-branch-fork-fetch-merge-rebase-and-clon"
                      target="_blank"
                      className="text-blue-600 flex items-center gap-3 w-fit"
                    >
                      <span className="w-[4]">
                  ...
                  <div className="">
                    <a
                      href="https://git-scm.com/book/en/v2/Git-Branching-Remote-Branches#Tracking-Branches"
                      target="_blank"
                      className="text-blue-600 flex items-center gap-3 w-fit"
                    >
                      <span className="w-[4]">
                ...
                <div className="mt-4 mb-4">
                  ...
                  <div className="">
                    ...
                    >
                      ...
                      <span className="lowercase">Learn TypeScript</span>
                    </a>
                  </div>
                </div>
              </div>
